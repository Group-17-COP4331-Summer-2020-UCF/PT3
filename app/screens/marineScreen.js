...
export const MarineScreen = ({ navigation }) => {
    ...
    if(testNum=="1"){
      return (
        ...
        <View>
          <Button title="Begin Pull-Up Section" onPress={() => setNum("2a")}/>
       ...
       return(
         ...
         <View>
           <TextInput
            ...
            placeholder="   Number of Pull-Ups Completed"
            placeholderTextColor="#504747"
           />
           <Button title="Begin Crunches Section" onPress={() => setNum("5")}/>
           <Button title ="Back" onPress={() => navigation.goBack()}/>
         </View>
         </LinearGradient>
	   );
       ...
       return(
         ...
         <View>
           ...
           />
            <TextInput
            style={styles.inputTextBox}
            placeholder="   Number of Crunches Completed"
            placeholderTextColor="#504747"
          />
       ...
       return(
         ...
         <View>
           ...
           <Button title="Timed, GPS tracked run. when 3 miles is reached move on" onPress={() => setNum("9")}/>
           <Button title ="Back" onPress={() => navigation.goBack()}/>
         </View>
         </LinearGradient>
	   );
